...
use App\Http\Requests\Admin\AccountFilterRequest;
...
class CategoryManagerController extends Controller 
{
     ...
     * 
     * @param  integer      ID record will delete.
     * @return redirect
     */
    function destroy($id){
     ...
     * 
     * @param  integer      Record ID editing.
     * @param  Request      request
     * @return redirect
     */
     ...
     * 
     * @param  integer      ID of record need edit.
     * @return Response
     */
    function edit($id){
        $category = Category::find($id);
     ...
     * 
     * @param  Request      request
     * @return array        Array object model
     */
    public function filter(Request $request) {
        ...
        // Filter if has a id or has name:
        else {
